...
Producers 
executed a loop _ in the loop m_input_received is true:
a1) took a inout
...
Consumer part
a) waiting for signal


lock guard - 

unique lock - allows to release resource at the end or middle based on condition
*/
